...
// the request, read from ~/.enforcer/credentials.json, the file /enforcer:login writes and
// enforcer-governor's hooks read too: sign in once and the MCP server and
// the governor are both signed in.
//
