...
| `enforcer-governor` | opt-in | Decides whether an agent action may run and keeps a tamper-evident record. Uses the `enforcer` sign-in. | `instruxi-io/enforcer-governor`, tag `v2.6.1` |
